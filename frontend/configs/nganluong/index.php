	...
	<form  name="NLpayBank" action="" method="post">
		<table style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr><td>Số tiền thanh toán: </td>
				<td>
					 <input type="text" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="<?php $price_total= number_format($_SESSION['order']['price_total']); echo $price_total ?>">
				</td>
			</tr>
			<tr><td>Họ Tên: </td>
				<td>
