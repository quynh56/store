 ...
 * Time: 7:56 PM
 */
//test chức năng gửi mail sử dụng thư viện PHPMailer thực tế nếu muốn gửi mail, nên dùng các thư viện bên ngoài, thay vì dùng hàm mail()
//của PHP. Vì việc gửi mail phụ thuộc vào nhiều yếu tố như cấu hình ...
?>
<?php
...
try {
    ...
    //Recipients
    //gửi từ ai
    $mail->setFrom('dangthithuxxx@gmail.com', 'Gui tu Thu');
    //gửi tới ai
